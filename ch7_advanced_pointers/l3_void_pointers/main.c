...
static MunitResult test_zero_out_integer(
...
static MunitResult test_zero_out_float(
    const MunitParameter params[], void* data) {
...
static MunitResult test_zero_out_bool(
    const MunitParameter params[], void* data) {
...
static MunitResult test_zero_out_nonzero_values(
    const MunitParameter params[], void* data) {
