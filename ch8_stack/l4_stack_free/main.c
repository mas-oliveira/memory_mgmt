...
/* free_stack                                               */
/* --------------------------------------------------------- */
static MunitResult free_stack(
    const MunitParameter params[], void *data) {

    snek_stack_t *s = stack_new(5);

    int a = 42;
    stack_push(s, &a);

    // apenas chamamos stack_free e verificamos se não há crashes
    stack_free(s);
...
static MunitTest tests[] = {
    ...
    { "/free_stack", free_stack, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
